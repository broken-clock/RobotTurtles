...
public class Tortue extends Tuile {
    ...
    // Initialisation (ex�cut� d�s le chargement de Tortue en m�moire)
    static {
    ...
    // Permet de d�terminer si le contenu d'une case du plateau correspond � la repr�sentation d'une tortue
    ...
    // Permet de d�terminer le num�ro de joueur correspondant � une tortue � partie du contenu d'une case du plateau qui correspond � la repr�sentation d'une tortue
    ...
    public void avancer(LogiqueDeJeu logiqueDeJeu) {
        ...
        switch (caseDestination.getContenu()) {
            ...
            case "bord":
                // Alors elle retourne � sa position initiale
            ...
            case "J":
                ...
                // Si la tortue a atteint un joyau
                    ...
                    // Ce joueur doit ne plus jouer jusqu'� la prochaine manche / jusqu'� la fin
                    ...
                    if (logiqueDeJeu.getModeJeu().equals("normal")) {
                        ...
                        // On met � jour le score du joueur
            ...
            default:
                ...
                if (isReprTortue(caseDestination.getContenu())) {
                    ...
                    // Les deux tortues retournent � leurs positions de d�part respectives
                    this.retourPositionDepart(logiqueDeJeu);
    ...
    public void lancerLaser(LogiqueDeJeu logiqueDeJeu) {
        // D�terminer les coordonn�es de la case du plateau touch�e par le laser
        ...
        // Si caseLueContenu == null, alors le laser n'a rien touch�, donc on ne fait rien
    ...
    // Repr�sentation dans le plateau des tortues en fonction de leur orientation
