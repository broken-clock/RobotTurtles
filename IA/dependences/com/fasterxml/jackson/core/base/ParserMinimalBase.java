...
public abstract class ParserMinimalBase extends JsonParser
{
    ...
    protected void reportOverflowInt() throws IOException {
        this._reportError(String.format("Numeric value (%s) out of range of int (%d - %s)", this._longIntegerDesc(this.getText()), Integer.MIN_VALUE, Integer.MAX_VALUE));
    }
    
    protected void reportOverflowLong() throws IOException {
        this._reportError(String.format("Numeric value (%s) out of range of long (%d - %s)", this._longIntegerDesc(this.getText()), Long.MIN_VALUE, Long.MAX_VALUE));
    }
    
    protected String _longIntegerDesc(final String rawNum) {
    ...
    protected String _longNumberDesc(final String rawNum) {
        int rawLen = rawNum.length();
        if (rawLen < 1000) {
            return rawNum;
        }
