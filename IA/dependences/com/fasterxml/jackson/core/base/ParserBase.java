...
public abstract class ParserBase extends ParserMinimalBase
{
        ...
        try {
            ...
            if (NumberInput.inLongRange(buf, offset, len, this._numberNegative)) {
                ...
                if (expType == 1 || expType == 2) {
                    this._reportTooLongInt(expType, numStr);
                }
    ...
    protected void _reportTooLongInt(final int expType, final String rawNum) throws IOException {
        final String numDesc = this._longIntegerDesc(rawNum);
        this._reportError("Numeric value (%s) out of range of %s", numDesc, (expType == 2) ? "long" : "int");
    }
    ...
    protected void _handleBase64MissingPadding(final Base64Variant b64variant) throws IOException {
