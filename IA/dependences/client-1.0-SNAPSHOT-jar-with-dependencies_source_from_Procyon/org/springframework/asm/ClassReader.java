...
public class ClassReader
{
    ...
    private void readCode(final MethodVisitor mv, final Context context, int u) {
            ...
            if ("LocalVariableTable".equals(attrName)) {
                ...
                if ((context.flags & 0x2) == 0x0) {
                    ...
                    while (l > 0) {
                        ...
                        if (labels[label] == null) {
                            final Label label5 = this.readLabel(label, labels);
                            label5.status |= 0x1;
                        }
        ...
        while (u < codeEnd) {
            ...
            final Label m = labels[offset2];
            if (m != null) {
                mv.visitLabel(m);
                if ((context.flags & 0x2) == 0x0 && m.line > 0) {
                    mv.visitLineNumber(m.line, m);
                }
            }
            while (frame != null && (frame.offset == offset2 || frame.offset == -1)) {
                ...
                if (frameCount > 0) {
                    stackMap = this.readFrame(stackMap, zip, unzip, labels, frame);
                    --frameCount;
                }
                else {
                    frame = null;
            ...
            switch (ClassWriter.TYPE[opcode2]) {
                ...
                case 10: {
                    mv.visitJumpInsn(opcode2 - 33, labels[offset2 + this.readInt(u + 1)]);
                    u += 5;
                    continue;
                }
                case 17: {
                ...
                case 14: {
                    u = u + 4 - (offset2 & 0x3);
                    final int label2 = offset2 + this.readInt(u);
                    ...
                    mv.visitTableSwitchInsn(min, max, labels[label2], table);
                    continue;
                }
                case 15: {
                    u = u + 4 - (offset2 & 0x3);
                    ...
                    mv.visitLookupSwitchInsn(labels[label2], keys, values);
                    continue;
                }
                case 3: {
    ...
    private int readFrame(int stackMap, final boolean zip, final boolean unzip, final Label[] labels, final Context frame) {
