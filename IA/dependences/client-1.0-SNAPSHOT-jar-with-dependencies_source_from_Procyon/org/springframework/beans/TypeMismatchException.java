...
public class TypeMismatchException extends PropertyAccessException
{
    ...
    public TypeMismatchException(final PropertyChangeEvent propertyChangeEvent, final Class<?> requiredType) {
        this(propertyChangeEvent, requiredType, null);
    }
    
    public TypeMismatchException(final PropertyChangeEvent propertyChangeEvent, final Class<?> requiredType, final Throwable cause) {
    ...
    public TypeMismatchException(final Object value, final Class<?> requiredType) {
        this(value, requiredType, null);
    }
    
    public TypeMismatchException(final Object value, final Class<?> requiredType, final Throwable cause) {
