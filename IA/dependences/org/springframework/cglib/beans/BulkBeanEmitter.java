...
class BulkBeanEmitter extends ClassEmitter
{
    ...
    static {
        ...
        BULK_BEAN = TypeUtils.parseType("org.springframework.cglib.beans.BulkBean");
        BULK_BEAN_EXCEPTION = TypeUtils.parseType("org.springframework.cglib.beans.BulkBeanException");
    }
}
