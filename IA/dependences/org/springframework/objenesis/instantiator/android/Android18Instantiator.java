...
public class Android18Instantiator<T> implements ObjectInstantiator<T>
{
    ...
    public Android18Instantiator(final Class<T> type) {
        this.type = type;
    ...
    private static Method getNewInstanceMethod() {
        try {
            final Method newInstanceMethod = ObjectStreamClass.class.getDeclaredMethod("newInstance", Class.class, Long.TYPE);
